...
if __name__ == "__main__":
    ...
    parser.add_argument('-c', '--clean', action='store_false',
                        help='If used it will remove pn files before execution. So they need to be reloaded.')
    parser.add_argument('-b', '--blacklist', action='store_true',
                        help='If selected the blacklist will be (re-)created first')
    ...
    parser.add_argument('--relief', nargs='+', type=int, default=[],
                        help='Relief for Feature Selection. Recommended values: 40 60 80. Warning: Needs very high '
                             'memory (with the 70k files >12gb)')
    parser.add_argument('--rfecv', nargs='+', type=int, default=[],
    ...
    parser.add_argument('--pca', nargs='+', type=int, default=0, help='Dimension reduction with pca')
    parser.add_argument('--lda', nargs='+', type=int, default=0, help='Dimension reduction with ldldaa')
    parser.add_argument('--autoencoder', nargs='+', type=int, default=0, help='Dimension reduction with autoencoder')
    parser.add_argument('--umap', nargs='+', type=int, default=0, help='Dimension reduction with umap')
    ...
    parser.add_argument('--keepfl', action='store_true',
                        help='HANDLE WITH CARE: If used, the existing featurelist solution from previous runs will '
                             'not be deleted and instead be used for this run to speed up the process. Cant be used '
                             'together with --featurelists')
